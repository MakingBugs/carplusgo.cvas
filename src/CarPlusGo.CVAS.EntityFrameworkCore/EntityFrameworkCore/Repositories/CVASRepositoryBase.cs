...
namespace CarPlusGo.CVAS.EntityFrameworkCore.Repositories
{
    ...
    public abstract class CVASRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<CVASDbContext, TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        private DbTransaction GetActiveTransaction()
        {
            ...
            {
                { "ContextType", typeof(CVASDbContext) },
    ...
    /// <summary>
    /// Base class for custom repositories of the application.
    /// This is a shortcut of <see cref="CVASRepositoryBase{TEntity,TPrimaryKey}"/> for <see cref="int"/> primary key.
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class CVASRepositoryBase<TEntity> : CVASRepositoryBase<TEntity, int>, IRepository<TEntity>
